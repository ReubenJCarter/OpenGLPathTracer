...
"	vec3 origMultDirInv = rayOrig * rayDirInv;"
"	float dist = 1e10;"
"	triIndex = -1;"
"	BVHNode node;"
"	int nodeIndex = 0;"
...
"		if(RayIntersectBox(rayOrig, rayDirInv, origMultDirInv, minaabb, maxaabb, dist))"
"		{"
"			if(isLeaf)"
"			{"
...
"					vec3 a = texelFetch(verticiesPosBT, tri.x).xyz;"
"					vec3 b = texelFetch(verticiesPosBT, tri.y).xyz;"
"					vec3 c = texelFetch(verticiesPosBT, tri.z).xyz;"
"					vec4 h;"
